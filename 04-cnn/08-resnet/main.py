...
def main():
    ...
    resnet = model.ResNet18(num_classes=num_classes).to(device)
    optimizer = torch.optim.SGD(lr=learning_rate, params=resnet.parameters(), momentum=momentum, weight_decay=weight_decay)
