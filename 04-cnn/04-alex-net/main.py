...
def train_model(num_labels: int = 10):
    ...
    alexnet = model.AlexNet(num_classes=num_classes).to(device)

    optimizer = torch.optim.SGD(lr=learning_rate, params=alexnet.parameters(), momentum=momentum, weight_decay=weight_decay)
