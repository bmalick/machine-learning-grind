...
def init_from(config):
    if config.init_from == "scratch":
        ...
        gpt = Module(TrainConfig(**checkpoint["model_config"]))
        ...
        return gpt, {"iter_num": checkpoint["iter_num"], "best_eval_loss": checkpoint["best_eval_loss"],
                     "opt_state_dict": checkpoint["optimizer"], "losses": checkpoint["losses"]}
    else:
